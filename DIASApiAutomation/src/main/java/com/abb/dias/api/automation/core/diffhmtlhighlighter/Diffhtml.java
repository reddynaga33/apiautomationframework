...
public class Diffhtml implements CommandVisitor<Character>  {
	...
	public void generateHTML(String diffLocation) throws IOException {
		...
		// File("C:\\Users\\INNAALA\\Desktop\\ex\\difftemplate.html"), "utf-8");
		...
		TestLogger.testMessage("HTML Diff file is generated");
		Reporter.log("HTML Diff file is generated");
